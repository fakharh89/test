//
//  ASSoftwareRevisionCharacteristic.m
//  Pods
//
...
@interface ASSoftwareRevisionCharacteristic ()

@property (copy, readwrite, nonatomic) void (^readCompletion)(NSError *error);

@end

@implementation ASSoftwareRevisionCharacteristic
...
- (BOOL)updateDeviceWithData:(NSString *)data error:(NSError *__autoreleasing *)error {
    self.device.softwareRevision = data;
    return YES;
}
