...
@interface ASErrorStateCharacteristic ()
...
@implementation ASErrorStateCharacteristic
...
- (void)processUpdateDeviceAndSendNotificationWithError:(NSError *)error  {
    ...
    ASBLEResult<ASErrorState *> *result = [self process];
