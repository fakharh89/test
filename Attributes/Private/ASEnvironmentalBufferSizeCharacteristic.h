//
//  ASEnvironmentalBufferSizeCharacteristic.h
//  Pods
//
...
@interface ASEnvironmentalBufferSizeCharacteristic : ASCharacteristic <ASReadableCharacteristic, ASWriteableCharacteristic>
