...
@class ASBeaconModeCharacteristic;
@class ASBLEParametersCharacteristic;
@class ASBLEConnectionModeCharacteristic;

@interface ASServiceV4 : ASService <ASService>
...
@property (strong, readwrite, nonatomic) ASBeaconModeCharacteristic *beaconModeCharacteristic;
@property (strong, readwrite, nonatomic) ASBLEParametersCharacteristic *BLEParametersCharacteristic;
@property (strong, readwrite, nonatomic) ASBLEConnectionModeCharacteristic *BLEConnectionModeCharacteristic;
